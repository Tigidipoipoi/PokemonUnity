...
public class DayNightCycle : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        skyLight = new Color[24] {
            new Color(0.14f,0.20f,0.47f,1), new Color(0.14f,0.20f,0.47f,1), new Color(0.14f,0.20f,0.47f,1), new Color(0.14f,0.20f,0.47f,1),
            new Color(0.47f,0.51f,0.86f,1), new Color(0.47f,0.51f,0.86f,1), new Color(0.63f,0.75f,1,1),     new Color(0.63f,0.75f,1,1),
            ...
            new Color(1,1,1,1),             new Color(1,1,1,1),             new Color(0.94f,0.67f,0.43f,1), new Color(0.94f,0.67f,0.43f,1),
            new Color(0.47f,0.51f,0.86f,1), new Color(0.24f,0.31f,0.67f,1), new Color(0.24f,0.31f,0.67f,1), new Color(0.14f,0.20f,0.47f,1) };
    ...
    { //repeat every second
        while (true)
        {
            ...
            if (!debugCustomTime) { yield return new WaitForSeconds(1f); } //wait a second before repeating
