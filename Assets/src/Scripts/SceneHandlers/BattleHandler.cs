...
public class BattleHandler : MonoBehaviour
{
    ...
    //pokemon
    private OwnedPokemon[] pokemon = new OwnedPokemon[6];
    ...
    private PokemonType[] pokemonType1 = new PokemonType[]
    {
        PokemonType.None, PokemonType.None, PokemonType.None,
        PokemonType.None, PokemonType.None, PokemonType.None
    };

    private PokemonType[] pokemonType2 = new PokemonType[]
    {
        PokemonType.None, PokemonType.None, PokemonType.None,
        PokemonType.None, PokemonType.None, PokemonType.None
    };

    private PokemonType[] pokemonType3 = new PokemonType[]
    {
        PokemonType.None, PokemonType.None, PokemonType.None,
        PokemonType.None, PokemonType.None, PokemonType.None
    };
    ...
    private OwnedPokemon[] commandPokemon = new OwnedPokemon[6];
    ...
    private IEnumerator displayPartyBar(bool isOpponent, OwnedPokemon[] party)
    {
        Image bar = (isOpponent) ? opponentPartyBar : playerPartyBar;
        Image[] space = (isOpponent) ? opponentPartyBarSpace : playerPartyBarSpace;
        ...
        for (int i = 0; i < 6; i++)
        {
            ...
            if (party.Length > i)
            {
                if (party[i] != null)
                {
                    if (party[i].CurrentStatus == PokemonStatus.FAINTED)
                    {
                        space[i].sprite = partyFaintTex;
                    }
                    else if (party[i].CurrentStatus == PokemonStatus.NONE)
                    {
    ...
    private void updatePokemonStatsDisplay(int position)
    {
        if (pokemon[position] != null)
        {
            ...
            if (pokemon[position].Gender == PokemonGender.FEMALE)
            {
                statsGender[position].text = "♀";
                statsGender[position].color = new Color(1, 0.2f, 0.2f, 1);
            }
            else if (pokemon[position].Gender == PokemonGender.MALE)
            {
                statsGender[position].text = "♂";
            ...
            statsLevel[position].text = "" + pokemon[position].CurrentLevel;
            ...
            if (pokemon[position].CurrentStatus != PokemonStatus.NONE)
            {
                statsStatus[position].sprite =
                    Resources.Load<Sprite>("PCSprites/status" + pokemon[position].CurrentStatus.ToString());
            }
            else
            {
            ...
            {
                pokemon0CurrentHP.text = "" + pokemon[0].GetCurrentLevelStatValue(PokemonStatType.HP);
                pokemon0CurrentHPShadow.text = pokemon0CurrentHP.text;
                pokemon0MaxHP.text = "" + pokemon[0].GetCurrentLevelStatValue(PokemonStatType.HP);
                pokemon0MaxHPShadow.text = pokemon0MaxHP.text;
                float expCurrentLevel =
                    PokemonLevelingRateHelper.GetRequiredExperienceToTargetLevel(pokemon[0].Species.LevelingRate,
                        pokemon[0].CurrentLevel);
                float expNextlevel =
                    PokemonLevelingRateHelper.GetRequiredExperienceToTargetLevel(pokemon[0].Species.LevelingRate,
                        pokemon[0].CurrentLevel + 1);
                float expAlong = pokemon[0].CurrentExperience - expCurrentLevel;
    ...
    private void updateMovesetDisplay(OwnedPokemonMove[] pMoveset)
    {
        for (int i = 0; i < 4; i++)
        {
            if (pMoveset[i] != null)
            {
                PokemonType type = pMoveset[i].Move.CurrentType;
                ...
                buttonMoveName[i].text = pMoveset[i].Move.Name;
                buttonMoveNameShadow[i].text = buttonMoveName[i].text;
                buttonMovePP[i].text = pMoveset[i].CurrentPP + "/" + pMoveset[i].CurrentMaxPP;
        ...
        for (int i = 0; i < 6; i++)
        {
            ...
            else
            {
                ...
                if (i == 0)
                {
                    ...
                    {
                        if (selectedPokemon.CurrentStatus != PokemonStatus.FAINTED)
                        {
                ...
                pokemonSlotHPBar[i].rectTransform.sizeDelta =
                    new Vector2(
                        Mathf.FloorToInt(48f *
                                         ((float)selectedPokemon.GetCurrentLevelStatValue(PokemonStatType.HP) / (float)selectedPokemon.GetCurrentLevelStatValue(PokemonStatType.HP))), 4);

                setHPBarColor(pokemonSlotHPBar[i], 48f);

                pokemonSlotLevel[i].text = "" + selectedPokemon.CurrentLevel;
                pokemonSlotLevelShadow[i].text = pokemonSlotLevel[i].text;
                pokemonSlotCurrentHP[i].text = "" + selectedPokemon.GetCurrentLevelStatValue(PokemonStatType.HP);
                pokemonSlotCurrentHPShadow[i].text = pokemonSlotCurrentHP[i].text;
                pokemonSlotMaxHP[i].text = "" + selectedPokemon.GetCurrentLevelStatValue(PokemonStatType.HP);
                ...
                if (selectedPokemon.CurrentStatus != PokemonStatus.NONE)
                {
                    pokemonSlotStatus[i].sprite =
                        Resources.Load<Sprite>("PCSprites/status" + selectedPokemon.CurrentStatus.ToString());
                }
                else
                {
    ...
    private void updatePokemonSummaryDisplay(OwnedPokemon selectedPokemon)
    {
        ...
        pokemonSelectedLevel.text = "" + selectedPokemon.CurrentLevel;
        ...
        //PokemonType type1 = PokemonDatabase.Instance.GetPokemonSpeciesByGameId(selectedPokemon.getID()).getType1();
        //PokemonType type2 = PokemonDatabase.Instance.GetPokemonSpeciesByGameId(selectedPokemon.getID()).getType2();
        ...
        float expDistance = expAlong / (expNextlevel - expCurrentLevel);
        pokemonSummaryNextLevelEXP.text = "" + (expNextlevel - selectedPokemon.CurrentExperience);
        ...
        //Stats
        float currentHP = selectedPokemon.GetCurrentLevelStatValue(PokemonStatType.HP);
        ...
        for (int i = 0; i < 4; i++)
        {
            ...
            {
                pokemonMovesName[i].text = ownedPokemonMove.Move.Name;
                pokemonMovesType[i].sprite =
                    Resources.Load<Sprite>("PCSprites/type" + PokemonTypeHelper.GetName(ownedPokemonMove.Move.CurrentType));
                pokemonMovesPPText[i].text = "PP";
                pokemonMovesPP[i].text = ownedPokemonMove.CurrentPP + "/" + ownedPokemonMove.CurrentMaxPP;
            }
            else
            {
        ...
        for (int i = 0; i < 7; i++)
        {
            if (i != pokePartyPosition)
            {
                ...
                if (i == 0)
                {
                    ...
                    {
                        buttonPokemonSlot[i].sprite = (SaveData.currentSave.PC.boxes[0][i].CurrentStatus !=
                                                       PokemonStatus.FAINTED)
                            ? buttonPokemonRoundTex
                            : buttonPokemonRoundFntTex;
                    }
                }
    ...
    private int updateMovesPosition(int newPosition)
    {
        ...
        if (newPosition < 4)
        {
            var moveset = SaveData.currentSave.PC.boxes[0][pokePartyPosition].GetMoveset();
            var pokemonMove = moveset[newPosition];
            if (pokemonMove == null)
            {
            ...
            else
            {
                pokemonMovesSelectedCategory.sprite =
                    Resources.Load<Sprite>("PCSprites/category" + PokemonMoveHelper.GetMoveCategoryName(pokemonMove.BattleCategory));

                var damageEffect = pokemonMove.Effects.Find(effect => effect.Type == PokemonMoveEffectType.Damage);
                if (damageEffect != null)
                {
                    pokemonMovesSelectedPower.text = damageEffect.Args.Replace("-", "");
                }
                else
                {
                ...
                {
                    pokemonMovesSelectedAccuracy.text = pokemonMove.Accuracy.ToString();
                }
                else
                {
    ...
    private float calculateDamage(int attackerPosition, int targetPosition, MoveData move)
    {
        ...
        {
            baseDamage = ((2f * (float)pokemon[attackerPosition].CurrentLevel + 10f) / 250f) *
    ...
    private float getSuperEffectiveModifier(PokemonType attackingType, PokemonType targetType)
    {
        if (attackingType == PokemonType.Bug)
        {
            if (targetType == PokemonType.Dark || targetType == PokemonType.Grass ||
                targetType == PokemonType.Psychic)
            {
                return 2f;
            }
            else if (targetType == PokemonType.Fairy || targetType == PokemonType.Fighting ||
                     targetType == PokemonType.Fire || targetType == PokemonType.Flying ||
                     targetType == PokemonType.Ghost || targetType == PokemonType.Poison ||
                     targetType == PokemonType.Steel)
            {
                return 0.5f;
            }
        }
        else if (attackingType == PokemonType.Dark)
        {
            if (targetType == PokemonType.Ghost || targetType == PokemonType.Psychic)
            {
                return 2f;
            }
            else if (targetType == PokemonType.Dark || targetType == PokemonType.Fairy ||
                     targetType == PokemonType.Fighting)
            {
                return 0.5f;
            }
        }
        else if (attackingType == PokemonType.Dragon)
        {
            if (targetType == PokemonType.Dragon)
            {
                return 2f;
            }
            else if (targetType == PokemonType.Steel)
            {
                return 0.5f;
            }
            else if (targetType == PokemonType.Fairy)
            {
                return 0f;
            }
        }
        else if (attackingType == PokemonType.Electric)
        {
            if (targetType == PokemonType.Flying || targetType == PokemonType.Water)
            {
                return 2f;
            }
            else if (targetType == PokemonType.Dragon || targetType == PokemonType.Electric ||
                     targetType == PokemonType.Grass)
            {
                return 0.5f;
            }
            else if (targetType == PokemonType.Ground)
            {
                return 0f;
            }
        }
        else if (attackingType == PokemonType.Fairy)
        {
            if (targetType == PokemonType.Dark || targetType == PokemonType.Dragon ||
                targetType == PokemonType.Fighting)
            {
                return 2f;
            }
            else if (targetType == PokemonType.Fire || targetType == PokemonType.Poison ||
                     targetType == PokemonType.Steel)
            {
                return 0.5f;
            }
        }
        else if (attackingType == PokemonType.Fighting)
        {
            if (targetType == PokemonType.Dark || targetType == PokemonType.Ice ||
                targetType == PokemonType.Normal || targetType == PokemonType.Rock ||
                targetType == PokemonType.Steel)
            {
                return 2f;
            }
            else if (targetType == PokemonType.Bug || targetType == PokemonType.Fairy ||
                     targetType == PokemonType.Flying || targetType == PokemonType.Poison ||
                     targetType == PokemonType.Psychic)
            {
                return 0.5f;
            }
            else if (targetType == PokemonType.Ghost)
            {
                return 0f;
            }
        }
        else if (attackingType == PokemonType.Fire)
        {
            if (targetType == PokemonType.Bug || targetType == PokemonType.Grass ||
                targetType == PokemonType.Ice || targetType == PokemonType.Steel)
            {
                return 2f;
            }
            else if (targetType == PokemonType.Dragon || targetType == PokemonType.Fire ||
                     targetType == PokemonType.Rock || targetType == PokemonType.Water)
            {
                return 0.5f;
            }
        }
        else if (attackingType == PokemonType.Flying)
        {
            if (targetType == PokemonType.Bug || targetType == PokemonType.Fighting ||
                targetType == PokemonType.Grass)
            {
                return 2f;
            }
            else if (targetType == PokemonType.Electric || targetType == PokemonType.Rock ||
                     targetType == PokemonType.Steel)
            {
                return 0.5f;
            }
        }
        else if (attackingType == PokemonType.Ghost)
        {
            if (targetType == PokemonType.Ghost || targetType == PokemonType.Psychic)
            {
                return 2f;
            }
            else if (targetType == PokemonType.Dark)
            {
                return 0.5f;
            }
            else if (targetType == PokemonType.Normal)
            {
                return 0f;
            }
        }
        else if (attackingType == PokemonType.Grass)
        {
            if (targetType == PokemonType.Ground || targetType == PokemonType.Rock ||
                targetType == PokemonType.Water)
            {
                return 2f;
            }
            else if (targetType == PokemonType.Bug || targetType == PokemonType.Dragon ||
                     targetType == PokemonType.Fire || targetType == PokemonType.Flying ||
                     targetType == PokemonType.Grass || targetType == PokemonType.Poison ||
                     targetType == PokemonType.Steel)
            {
                return 0.5f;
            }
        }
        else if (attackingType == PokemonType.Ground)
        {
            if (targetType == PokemonType.Electric || targetType == PokemonType.Fire ||
                targetType == PokemonType.Poison || targetType == PokemonType.Rock ||
                targetType == PokemonType.Steel)
            {
                return 2f;
            }
            else if (targetType == PokemonType.Bug || targetType == PokemonType.Grass)
            {
                return 0.5f;
            }
            else if (targetType == PokemonType.Flying)
            {
                return 0f;
            }
        }
        else if (attackingType == PokemonType.Ice)
        {
            if (targetType == PokemonType.Dragon || targetType == PokemonType.Flying ||
                targetType == PokemonType.Grass || targetType == PokemonType.Ground)
            {
                return 2f;
            }
            else if (targetType == PokemonType.Fire || targetType == PokemonType.Ice ||
                     targetType == PokemonType.Steel || targetType == PokemonType.Water)
            {
                return 0.5f;
            }
        }
        else if (attackingType == PokemonType.Normal)
        {
            if (targetType == PokemonType.Rock || targetType == PokemonType.Steel)
            {
                return 0.5f;
            }
            else if (targetType == PokemonType.Ghost)
        ...
        else if (attackingType == PokemonType.Poison)
        {
            if (targetType == PokemonType.Fairy || targetType == PokemonType.Grass)
            {
                return 2f;
            }
            else if (targetType == PokemonType.Poison || targetType == PokemonType.Ground ||
                     targetType == PokemonType.Rock || targetType == PokemonType.Ghost)
            {
                return 0.5f;
            }
            else if (targetType == PokemonType.Steel)
        ...
        else if (attackingType == PokemonType.Psychic)
        {
            if (targetType == PokemonType.Fighting || targetType == PokemonType.Poison)
            {
                return 2f;
            }
            else if (targetType == PokemonType.Psychic || targetType == PokemonType.Steel)
            {
                return 0.5f;
            }
            else if (targetType == PokemonType.Dark)
        ...
        else if (attackingType == PokemonType.Rock)
        {
            if (targetType == PokemonType.Bug || targetType == PokemonType.Fire ||
                targetType == PokemonType.Flying || targetType == PokemonType.Ice)
            {
                return 2f;
            }
            else if (targetType == PokemonType.Fighting || targetType == PokemonType.Ground ||
                     targetType == PokemonType.Steel)
            {
                return 0.5f;
            }
        }
        else if (attackingType == PokemonType.Steel)
        {
            if (targetType == PokemonType.Fairy || targetType == PokemonType.Ice ||
                targetType == PokemonType.Rock)
            {
                return 2f;
            }
            else if (targetType == PokemonType.Electric || targetType == PokemonType.Fire ||
                     targetType == PokemonType.Steel || targetType == PokemonType.Water)
            {
                return 0.5f;
            }
        }
        else if (attackingType == PokemonType.Water)
        {
            ...
            else if (targetType == PokemonType.Dragon || targetType == PokemonType.Grass ||
                     targetType == PokemonType.Water)
            {
                return 0.5f;
            }
    ...
    private int getHighestSpeedIndex()
    {
        ...
        for (int i = 0; i < 6; i++)
        {
            if (!pokemonHasMoved[i])
            {
                ...
                if (pokemon[i] != null)
                {
                    if (pokemon[i].CurrentStatus == PokemonStatus.PARALYZED)
                    {
    ...
    private bool switchPokemon(int switchPosition, OwnedPokemon newPokemon)
    {
        return switchPokemon(switchPosition, newPokemon, false, false);
    }

    /// Switch Pokemon
    private bool switchPokemon(int switchPosition, OwnedPokemon newPokemon, bool batonPass)
    {
        return switchPokemon(switchPosition, newPokemon, batonPass, false);
    }

    /// Switch Pokemon
    private bool switchPokemon(int switchPosition, OwnedPokemon newPokemon, bool batonPass, bool forceSwitch)
    {
        if (newPokemon == null)
        {
            return false;
        }
        if (newPokemon.CurrentStatus == PokemonStatus.FAINTED)
        {
            return false;
        }
        ...
        if (!forceSwitch)
        {
            ...
            {
                if (pokemon[switchPosition].CurrentStatus != PokemonStatus.FAINTED)
                {
                }
            }
        }
        ...
        // ToDo: Implement abilities and types
        //pokemonAbility[switchPosition] =
        //    PokemonDatabase.Instance.GetPokemonSpeciesByGameId(newPokemon.getID()).getAbility(newPokemon.getAbility());
        //pokemonType1[switchPosition] = PokemonDatabase.Instance.GetPokemonSpeciesByGameId(newPokemon.getID()).getType1();
        //pokemonType2[switchPosition] = PokemonDatabase.Instance.GetPokemonSpeciesByGameId(newPokemon.getID()).getType2();
        //pokemonType3[switchPosition] = PokemonType.None;
    ...
    private IEnumerator addExp(int position, int exp)
    {
        ...
        //while (expPool > 0)
        //{
        //    int expToNextLevel = pokemon[position].NextLevelExp - pokemon[position].CurrentExperience;
        ...
        //            StartCoroutine(
        //                drawTextAndWait(
        //                    pokemon[position].GetName() + " grew to Level " + pokemon[position].CurrentLevel + "!", 1.8f,
        //                    1.8f));

        //        string newMove = pokemon[position].MoveLearnedAtLevel(pokemon[position].CurrentLevel);
        ...
        //        expPool = 0;
        //        float levelStartExp =
        //            PokemonLevelingRateHelper.GetRequiredExperienceToTargetLevel(
        //                pokemon[position].Species.LevelingRate,
        //                pokemon[position].CurrentLevel);
        //        float currentExpMinusStart = pokemon[position].CurrentExperience - levelStartExp;
        //        float nextLevelExpMinusStart = pokemon[position].NextLevelExp - levelStartExp;
    ...
    private IEnumerator LearnMove(OwnedPokemon selectedPokemon, PokemonMove pMove)
    {
        int chosenIndex = 1;
        if (chosenIndex == 1)
        {
            ...
            while (learning)
            {
                ...
                if (selectedPokemon.GetMoveCount() == 4)
                {
                    ...
                    if (chosenIndex == 1)
                    {
                        ...
                        StartCoroutine(PKUScene.main.Summary.control(selectedPokemon, pMove.Name));
                ...
                {
                    selectedPokemon.TryAddMove(pMove);
    ...
    {
        var currentPokemon = pokemon[position];
        //set PokemonData
        pokemonStats[0][position] = currentPokemon.GetCurrentStatValue(PokemonStatType.Attack);
        pokemonStats[1][position] = currentPokemon.GetCurrentStatValue(PokemonStatType.Defence);
        pokemonStats[2][position] = currentPokemon.GetCurrentStatValue(PokemonStatType.SpecialAttack);
        pokemonStats[3][position] = currentPokemon.GetCurrentStatValue(PokemonStatType.SpecialDefence);
        pokemonStats[4][position] = currentPokemon.GetCurrentStatValue(PokemonStatType.Speed);
    }
        ...
        bool animate)
    {
        ...
        {
            if (pokemon[targetPosition].CurrentStatus != PokemonStatus.FAINTED)
            {
                ...
                else if (effect == MoveData.Effect.Burn)
                {
                    ...
                    {
                        if (pokemon[targetPosition].TrySetStatus(PokemonStatus.BURNED))
                        {
                            yield return
                                StartCoroutine(
                                    drawTextAndWait(
                ...
                else if (effect == MoveData.Effect.Freeze)
                {
                    if (Random.value <= parameter)
                    {
                        if (pokemon[targetPosition].TrySetStatus(PokemonStatus.FROZEN))
                        {
                            yield return
                                StartCoroutine(
                                    drawTextAndWait(
                ...
                else if (effect == MoveData.Effect.Paralyze)
                {
                    if (Random.value <= parameter)
                    {
                        if (pokemon[targetPosition].TrySetStatus(PokemonStatus.PARALYZED))
                        {
                            yield return
                                StartCoroutine(
                                    drawTextAndWait(
                ...
                else if (effect == MoveData.Effect.Poison)
                {
                    if (Random.value <= parameter)
                    {
                        if (pokemon[targetPosition].TrySetStatus(PokemonStatus.PoisonED))
                        {
                            yield return
                                StartCoroutine(
                                    drawTextAndWait(
                ...
                else if (effect == MoveData.Effect.Sleep)
                {
                    if (Random.value <= parameter)
                    {
                        if (pokemon[targetPosition].TrySetStatus(PokemonStatus.ASLEEP))
                        {
                            yield return
                                StartCoroutine(
                                    drawTextAndWait(
    ...
    private IEnumerator Heal(int index, int healAmount, bool curingStatus)
    {
        ...
        if ((!curingStatus && pokemon[index].GetCurrentLevelStatValue(PokemonStatType.HP) == pokemon[index].GetCurrentLevelStatValue(PokemonStatType.HP)) ||
            (curingStatus &&
             (pokemon[index].CurrentStatus == PokemonStatus.NONE || pokemon[index].CurrentStatus == PokemonStatus.FAINTED)))
        {
            //no effect
        ...
        else
        {
            ...
            if (curingStatus)
            {
                PokemonStatus status = pokemon[index].CurrentStatus;
                ...
                else if (status == PokemonStatus.BURNED)
                {
                    yield return
                        StartCoroutine(
                            drawTextAndWait(
                ...
                else if (status == PokemonStatus.FROZEN)
                {
                    yield return
                        StartCoroutine(
                ...
                else if (status == PokemonStatus.PARALYZED)
                {
                    yield return
                        StartCoroutine(
                            drawTextAndWait(
                ...
                else if (status == PokemonStatus.PoisonED)
                {
                    yield return
                        StartCoroutine(
                            drawTextAndWait(
            ...
            else
            {
                ...
                if (healAmount < 1.01f)
                {
                    healAmount = Mathf.CeilToInt((float)pokemon[index].GetCurrentLevelStatValue(PokemonStatType.HP) * healAmount);
                }

                //Heal the pokemon and record how much HP was healed
                int healedHP = pokemon[index].GetCurrentLevelStatValue(PokemonStatType.HP);
                pokemon[index].healHP(healAmount);
                healedHP = pokemon[index].GetCurrentLevelStatValue(PokemonStatType.HP) - healedHP;

                if (index == 0)
                {
                    yield return
                        StartCoroutine(stretchBar(statsHPBar[index], pokemon[index].getPercentHP() * 48f, 32, true,
                            pokemon0CurrentHP, pokemon0CurrentHPShadow, pokemon[index].GetCurrentLevelStatValue(PokemonStatType.HP)));
                }
                else
                {
                    yield return
    ...
    /// Basic Wild Battle
    public IEnumerator control(OwnedPokemon wildPokemon)
    {
        yield return StartCoroutine(control(false, new Trainer(new OwnedPokemon[] { wildPokemon }), false));
    }
    ...
    public IEnumerator control(bool isTrainerBattle, Trainer trainer, bool healedOnDefeat)
    {
        ...
        for (int i = 0; i < initialLevels.Length; i++)
        {
            if (SaveData.currentSave.PC.boxes[0][i] != null)
            {
                initialLevels[i] = SaveData.currentSave.PC.boxes[0][i].CurrentLevel;
            }
        }

        trainerBattle = isTrainerBattle;
        OwnedPokemon[] opponentParty = trainer.GetParty();
        ...
        if (pokemon[0] != null)
        {
            updateMovesetDisplay(pokemon[0].CurrentMoveset);
        }
        ...
        //		Debug.Log(pokemon[0].getName()+": HP: "+pokemon[0].GetCurrentLevelStatValue(PokemonStatType.HP)+"ATK: "+pokemon[0].getATK()+"DEF: "+pokemon[0].getDEF()+"SPA: "+pokemon[0].getSPA()+"SPD: "+pokemon[0].getSPD()+"SPE:"+pokemon[0].getSPE());
        //		Debug.Log(pokemon[3].getName()+": HP: "+pokemon[3].GetCurrentLevelStatValue(PokemonStatType.HP)+"ATK: "+pokemon[3].getATK()+"DEF: "+pokemon[3].getDEF()+"SPA: "+pokemon[3].getSPA()+"SPD: "+pokemon[3].getSPD()+"SPE:"+pokemon[3].getSPE());
        ...
        while (running)
        {
            ...
            commandPokemon = new OwnedPokemon[6];
            //
                        ...
                        while (currentTask == 1)
                        {
                            ...
                            else if (Input.GetButtonDown("Select"))
                            {
                                ...
                                else
                                {
                                    ...
                                    if (pokemon[currentPokemon].CurrentMoveset[0].CurrentPP == 0
                                        && pokemon[currentPokemon].CurrentMoveset[1].CurrentPP == 0
                                        && pokemon[currentPokemon].CurrentMoveset[2].CurrentPP == 0
                                        && pokemon[currentPokemon].CurrentMoveset[3].CurrentPP == 0)
                                    {
                                    ...
                                    else
                                    {
                                        ...
                                        if (pokemon[currentPokemon].CurrentMoveset[movePosition].CurrentPP > 0)
                                        {
                                        ...
                                        else if (Input.GetButtonDown("Select"))
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                if (selectedItem.getItemEffect() == ItemData.ItemEffect.HP)
                                                {
                                                    ...
                                                    if (pokemon[target].GetCurrentLevelStatValue(PokemonStatType.HP) < pokemon[target].GetCurrentLevelStatValue(PokemonStatType.HP))
                                                    {
                                                ...
                                                else if (selectedItem.getItemEffect() == ItemData.ItemEffect.STATUS)
                                                {
                                                    ...
                                                    if (statusCurer == "ALL" &&
                                                        pokemon[target].CurrentStatus.ToString() != "FAINTED" &&
                                                        pokemon[target].CurrentStatus.ToString() != "NONE")
                                                    {
                                                        statusCurer = pokemon[target].CurrentStatus.ToString();
                                                    }

                                                    if (pokemon[target].CurrentStatus.ToString() == statusCurer)
                                                    {
                                                        commandItem[currentPokemon] = selectedItem;
                                                        commandTarget[currentPokemon] = target;
                                ...
                                else
                                {
                                    ...
                                    while (currentTask == 5)
                                    {
                                        ...
                                        else if (Input.GetButtonDown("Select"))
                                        {
                                            if (summaryPosition == 0)
                                            {
                                                if (SaveData.currentSave.PC.boxes[0][pokePartyPosition].CurrentStatus !=
                                                    PokemonStatus.FAINTED)
                                                {
            ...
            for (int i = 0; i < pokemonPerSide; i++)
            {
                ...
                {
                    //check if struggle is to be used (no PP left in any move)
                    if (pokemon[pi].CurrentMoveset[0].CurrentPP == 0
                        && pokemon[pi].CurrentMoveset[1].CurrentPP == 0
                        && pokemon[pi].CurrentMoveset[2].CurrentPP == 0
                        && pokemon[pi].CurrentMoveset[3].CurrentPP == 0)
                    {
                    ...
                    else
                    {
                        ...
                        while (pokemonMoveset[pi] != null && string.IsNullOrEmpty(pokemonMoveset[pi][AImoveIndex])
                            && pokemon[pi].CurrentMoveset[AImoveIndex].CurrentPP == 0)
                        {
                            AImoveIndex = Random.Range(0, 4);
                        }
                        command[pi] = CommandType.Move;
                        commandMove[pi] = MoveDatabase.getMove(pokemonMoveset[pi][AImoveIndex]);
                        Debug.Log(commandMove[pi].getName() + ", PP: " + pokemon[pi].CurrentMoveset[AImoveIndex].CurrentPP);
                    }
                }
            }
                    ...
                    if (pokemon[movingPokemon] != null)
                    {
                        if (command[movingPokemon] == CommandType.Flee)
                        {
                            ...
                            if (movingPokemon < 3)
                            {
                                ...
                                int fleeChance = pokemon[movingPokemon].GetCurrentLevelStatValue(PokemonStatType.Speed) * 128;
                                fleeChance /= pokemon[3].GetCurrentLevelStatValue(PokemonStatType.Speed);
                                fleeChance += 30 * playerFleeAttempts;
                            ...
                            if (i < 3)
                            {
                                if (commandItem[movingPokemon].getItemEffect() == ItemData.ItemEffect.BALL)
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        float catchRate =
                                            (float)pokemon[targetIndex].Species.CatchProbability;
                                        float statusRate = 1f;
                                        if ((pokemon[targetIndex].CurrentStatus != PokemonStatus.NONE))
                                        {
                                            statusRate = (pokemon[targetIndex].CurrentStatus == PokemonStatus.ASLEEP ||
                                                          pokemon[targetIndex].CurrentStatus == PokemonStatus.FROZEN)
                                                ? 2.5f
                                                : 1.5f;
                                        }

                                        int modifiedRate =
                                            Mathf.FloorToInt(((3 * (float)pokemon[targetIndex].GetCurrentLevelStatValue(PokemonStatType.HP) -
                                                               2 * (float)pokemon[targetIndex].GetCurrentLevelStatValue(PokemonStatType.HP))
                                                              * catchRate * ballRate) /
                                                             (3 * (float)pokemon[targetIndex].GetCurrentLevelStatValue(PokemonStatType.HP)) * statusRate);
                                        ...
                                        if (shakes == 4)
                                        {
                                            ...
                                            if (chosenIndex == 1)
                                            {
                                                ...
                                                StartCoroutine(PKUScene.main.Typing.control(10, "",
                                                    pokemon[targetIndex].Gender, pokemon[targetIndex].GetIcons_()));
                                            ...
                                            Debug.Log("CurrentHP" + pokemon[targetIndex].GetCurrentLevelStatValue(PokemonStatType.HP));
                                            SaveData.currentSave.PC.addPokemon(new OwnedPokemon(pokemon[targetIndex],
                        ...
                        else if (command[movingPokemon] == CommandType.Move)
                        {
                            ...
                            if (pokemon[movingPokemon].CurrentStatus != PokemonStatus.FAINTED)
                            {
                                ...
                                bool canMove = true;
                                if (pokemon[movingPokemon].CurrentStatus == PokemonStatus.PARALYZED)
                                {
                                ...
                                else if (pokemon[movingPokemon].CurrentStatus == PokemonStatus.FROZEN)
                                {
                                    ...
                                    {
                                        pokemon[movingPokemon].TrySetStatus(PokemonStatus.NONE);
                                ...
                                else if (pokemon[movingPokemon].CurrentStatus == PokemonStatus.ASLEEP)
                                {
                                    // ToDo: implement sleep.
                                    //pokemon[movingPokemon].removeSleepTurn();
                                    //if (pokemon[movingPokemon].CurrentStatus == PokemonStatus.ASLEEP)
                                    //{
                                    //    yield return
                                    //        StartCoroutine(
                                    //            drawTextAndWait(
                                ...
                                if (canMove)
                                {
                                    ...
                                    else if (commandMove[movingPokemon].hasMoveEffect(MoveData.Effect.SetDamage))
                                    {
                                        ...
                                        if (damageToDeal == 0)
                                        {
                                            damageToDeal = pokemon[movingPokemon].CurrentLevel;
                                        }
                                    ...
                                    else
                                    {
                                        ...
                                        if (commandMove[movingPokemon].getCategory() == MoveData.Category.PHYSICAL)
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                if (pokemon[movingPokemon].CurrentStatus == PokemonStatus.BURNED)
                                                {
                                                    damageToDeal /= 2f;
                                                }
                                            }
                                    ...
                                    //inflict damage
                                    int DEBug_beforeHP = pokemon[targetIndex].GetCurrentLevelStatValue(PokemonStatType.HP);
                                    pokemon[targetIndex].removeHP(Mathf.FloorToInt(damageToDeal));
                                    Debug.Log(DEBug_beforeHP + " - " + damageToDeal + " = " +
                                              pokemon[targetIndex].GetCurrentLevelStatValue(PokemonStatType.HP));
                                    ...
                                    if (pokemon[targetIndex].CurrentStatus == PokemonStatus.FAINTED)
                                    {
                                        ...
                                        if (targetIndex > 2)
                                        {
                                            ...
                                            {
                                                if (pokemon[i2].CurrentStatus != PokemonStatus.FAINTED)
                                                {
                                                    float isWildMod = (trainerBattle) ? 1.5f : 1f;
                                                    float baseExpYield = pokemon[targetIndex].Species.BattleReward.ExperienceYield;
                                                    float luckyEggMod = (pokemon[i2].getHeldItem() == "Lucky Egg")
                                                        ? 1.5f
                                                        : 1f;
                                                    float OTMod = 1.0f;
                                                    // ToDo: implement owner.
                                                    //(pokemon[i2].getIDno() != SaveData.currentSave.playerID)
                                                    //? 1.5f
                                                    //: 1f;
                                                    ...
                                                    int exp =
                                                        Mathf.CeilToInt((isWildMod * baseExpYield * IVMod * OTMod *
                                                                         luckyEggMod *
                                                                         (float)pokemon[targetIndex].CurrentLevel) / 7 *
                                                                        sharedMod);
                        ...
                        else if (command[movingPokemon] == CommandType.Switch)
                        {
                            ...
                            {
                                //DEBug
                                Debug.Log(pokemon[0].Species.GameId);
            ...
            if (running)
            {
                ...
                for (int i = 0; i < 6; i++)
                {
                    if (pokemon[i] != null)
                    {
                        if (pokemon[i].CurrentStatus == PokemonStatus.BURNED ||
                            pokemon[i].CurrentStatus == PokemonStatus.PoisonED)
                        {
                            pokemon[i].removeHP(pokemon[i].GetCurrentLevelStatValue(PokemonStatType.HP) / 8);
                            if (pokemon[i].CurrentStatus == PokemonStatus.BURNED)
                            {
                                yield return
                                    StartCoroutine(
                            ...
                            else if (pokemon[i].CurrentStatus == PokemonStatus.PoisonED)
                            {
                                yield return
                                    StartCoroutine(
                                        drawTextAndWait(
                            ...
                            if (i == 0)
                            {
                                ...
                                yield return
                                    StartCoroutine(stretchBar(statsHPBar[i],
                                        ...
                                        pokemon0CurrentHPShadow, pokemon[i].GetCurrentLevelStatValue(PokemonStatType.HP)));
                            }
                            else
                            {
                                yield return
                        ...
                        if (pokemon[i].CurrentStatus == PokemonStatus.FAINTED)
                        {
                            //debug = array of GUITextures not yet implemented
                            yield return
                                StartCoroutine(drawTextAndWait(
            ...
            if (running)
            {
                ...
                {
                    //check each opponent
                    if (opponentParty[i].CurrentStatus != PokemonStatus.FAINTED)
                    {
                ...
                if (!allOpponentsDefeated && !allPlayersDefeated)
                {
                    ...
                    for (int i = 0; i < pokemonPerSide; i++)
                    {
                        ...
                        if (pokemon[i + 3] == null)
                        {
                            ...
                            {
                                if (opponentParty[i2].CurrentStatus != PokemonStatus.FAINTED)
                                {
                                    //check that pokemon is not on the field
                                    bool notOnField = true;
                                    ...
                                    if (notOnField)
                                    {
                                        ...
                                        {
                                            //DEBug
                                            Debug.Log(pokemon[3].Species.GameId);
                                        ...
                                        while (currentTask == 5)
                                        {
                                            ...
                                            else if (Input.GetButtonDown("Select"))
                                            {
                                                if (summaryPosition == 0)
                                                {
                                                    // switch
                                                    if (
                                                        SaveData.currentSave.PC.boxes[0][pokePartyPosition].CurrentStatus !=
                                                        PokemonStatus.FAINTED)
                                                    {
                                                        //check that pokemon is not on the field
                                                        bool notOnField = true;
        ...
        if (victor == 0 || healedOnDefeat)
        {
            for (int i = 0; i < initialLevels.Length; i++)
            {
                if (SaveData.currentSave.PC.boxes[0][i] != null)
                {
                    ...
                    if (SaveData.currentSave.PC.boxes[0][i].CurrentLevel != initialLevels[i])
                    {
                        //if can evolve
